...
export function Room() {
	...
	async function handleLikeQuestion(questionId: string, likeId: string | undefined) {
		...
		if (!user) {
			toast('Você precisa fazer login para curtir');
		}
	}
				...
				<form onSubmit={handleSendQuestion}>
					...
					<div className="form-footer">
						...
						!roomPermission ? (
							...
							<span><button onClick={signInWithGoogle}>Faça seu login.</button></span>
							}
						<Button type="submit" disabled={!roomPermission && !user}>Enviar pergunta</Button>
					</div>
				</form>
